...
import './conversationalScreen.module.scss';
...
export default function ConversationalScreen() {
  ...
  const transcriptMessages = useMemo(
    () => [{ text: caption || t('Hi Emily, thank you for joining today. I will be guiding this interview.') }],
    [caption],
  );
  ...
  return (
    <section className="screen active" id="screen-conversational">
      ...
      <InterviewMainBand
        ...
        techqnaClassName={`techqna-content--conversational${state.transitionModal ? ' techqna-content--transition-handoff' : ''}`}
      >
        {/* Same column width as Tech Q&A questions panel; visually empty */}
